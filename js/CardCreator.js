...
const createCard = (result) => {
  ...
  const cardTemplate = `<div class="col-6 col-sm-6 col-md-3 col-lg-3 gy-4"><a class="text-decoration-none" href="./album.html?id=${idAlbum}"><div class="card bg-dark rounded-3 h-100" id="${idAlbum}">
